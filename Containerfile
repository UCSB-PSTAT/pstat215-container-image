...
RUN R -e "install.packages("StanHeaders", repos = c("https://mc-stan.org/r-packages/", getOption("repos"), Ncpus = parallel::detectCores())); install.packages("rstan", repos = c("https://mc-stan.org/r-packages/", Ncpus = parallel::detectCores(), getOption("repos")))"
